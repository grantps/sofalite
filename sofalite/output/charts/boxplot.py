...
make_chart_{{chart_uuid}} = function(){
    ...
    {% for series_spec in dojo_series_specs %}
        ...
        {% for box_spec in series_spec.box_specs %}
            ...
            summary_data_{{series_spec.series_id}}_{{loop.index0}}['lwhisker'] = {{box_spec.lower_whisker_val}};
            summary_data_{{series_spec.series_id}}_{{loop.index0}}['lwhisker_rounded'] = {{box_spec.lower_whisker_val_rounded}};
            summary_data_{{series_spec.series_id}}_{{loop.index0}}['lbox'] = {{box_spec.lower_box_val}};
            summary_data_{{series_spec.series_id}}_{{loop.index0}}['lbox_rounded'] = {{box_spec.lower_box_val_rounded}};
            summary_data_{{series_spec.series_id}}_{{loop.index0}}['median'] = {{box_spec.median_val}};
            summary_data_{{series_spec.series_id}}_{{loop.index0}}['median_rounded'] = {{box_spec.median_val_rounded}};
            summary_data_{{series_spec.series_id}}_{{loop.index0}}['ubox'] = {{box_spec.upper_box_val}};
            summary_data_{{series_spec.series_id}}_{{loop.index0}}['ubox_rounded'] = {{box_spec.upper_box_val_rounded}};
            summary_data_{{series_spec.series_id}}_{{loop.index0}}['uwhisker'] = {{box_spec.upper_whisker_val}};
            summary_data_{{series_spec.series_id}}_{{loop.index0}}['uwhisker_rounded'] = {{box_spec.upper_whisker_val_rounded}};
    ...
    for i, data_series_spec in enumerate(indiv_chart_spec.data_series_specs):
        ...
        for box_item in data_series_spec.box_items:
            ...
            box_spec = DojoBoxSpec(
                ...
                lower_box_val=box_item.lower_box_val,
                lower_box_val_rounded=box_item.lower_box_val_rounded,
                lower_whisker_val=box_item.lower_whisker_val,
                ...
                upper_whisker_val_rounded=box_item.upper_whisker_val_rounded,
            )
