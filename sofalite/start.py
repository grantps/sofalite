...
from sofalite.output.charts import area, bar, histo, line, pie, scatterplot  ## needed so singledispatch registration can occur
...
def run_scatterplot():
    style_dets = get_style_dets(style='default')
    data_series_spec_male = ScatterDataSeriesSpec(
        lbl='Male',
        xy_pairs=[
    ...
    data_series_spec_female = ScatterDataSeriesSpec(
        lbl='Female',
        xy_pairs=[
